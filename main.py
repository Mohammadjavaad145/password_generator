...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("background-color:#21CFC7;")
        ...
        self.upper_case.setGeometry(35, 180, 120, 40)
        ...
        self.lower_case.setGeometry(165, 180, 120, 40)
        ...
        # create result label
        lbl_result = QLabel("Password :", self)
        lbl_result.setFont(QFont("arial", 15))
        lbl_result.setGeometry(50, 430, 100, 50)
